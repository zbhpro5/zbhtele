...
inf = (y+'T'+a+'E'+b+'L'+y+'E'+m+'G'+c+'R'+r+'A'+y+'M'+'  '+y+'S'+a+'C'+b+'R'+y+'A'+m+'P'+c+'E'+r+'R'+y+'  '+'2'+y+'0'+a+'2'+b+'2'+y+'  '+m+'B'+c+'Y'+r+'  '+y+'Z'+m+'A'+c+'I'+r+'N'+y+'I'  '+y+'H'+m+'A'+c+'R'+r+'U'+y+'N')
el=0
def Sleep(timE):
    try:
        time.sleep(timE)
...
def ospath():
    ...
    for po in range(o):
        ...
        with open('multi_log.txt', 'a') as f:
            f.write(api_id+'\n'+api_hash+'\n')
        client = TelegramClient("zbhpro5{}".format(z), api_id, api_hash)
        client.start()
        Sleep(1)
        clear()
        info()
